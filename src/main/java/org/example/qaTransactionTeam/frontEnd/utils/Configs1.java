...
public class Configs1 {
    ...
    public static final String environmentFrames = "https://innsmouth.payhub.com.ua/";

    public static final String loginTest = "uapay-admin-test";
    public static final String loginDev = "merchant-admin-uapay-dev";
