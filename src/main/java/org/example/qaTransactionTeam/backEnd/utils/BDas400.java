...
public class BDas400 {
    ...
    public static void BDas400(String base, String user, String password) throws ClassNotFoundException, SQLException, IllegalAccessException, InstantiationException {
        ...
        conn = DriverManager.getConnection("jdbc:as400://"+base+".fuib.com;libraries=LVFUIBCURR LVFUIBDDM CBA22 ITMRFUIB ITMDFUIB ITM22R ITM22D ASIT144402 ASIC144402 ASID144402 ASIR144402 ASIB144402 ASILIB FUIBGPL ITMSYNC QGPL QTEMP;secure=true;prompt=false;translate binary=true;naming=system", user, password);
        nameBD = base;
