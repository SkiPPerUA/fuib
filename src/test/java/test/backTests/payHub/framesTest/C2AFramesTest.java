...
@Test
public class C2AFramesTest extends BaseTest {

    C2AFrame c2aFrame;

    public void с2aFrame(){
        String body = "\"options\": {\n" +
                "        \"ttl\": 0,\n" +
                ...
                "      },\n" +
                "      \"sender\":{\n" +
                "         \"first_name\":\"jkasdfjkdsfnakjdsfnakdjsfnksajdfnsadkjfnaksjdnfak3\",\n" +
                "         \"last_name\":\"jkasdfjkdsfnakjdsfnakdjsfnksajdfnsadkjfnaksjdnfak4\",\n" +
