...
@Test
public class NBU_21_c4с_vmt extends BaseTest {
    ...
    public void positive_all_fields(){
        logStartTest("positive_all_fields");
        body = new HashMap<>();
        ...
        for (int i = 0; i < 1; i++){
            makeTran(body);
            p4p.P4Ppayment("70", false);
            p4p.P4Ppayment("30", false);
            wonderWoman.getStatus("2101", p4p.getSessionId());
        }
    }
